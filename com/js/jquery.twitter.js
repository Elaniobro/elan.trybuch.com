(function($) {
	...
	*/
	...
	$.fn.getTwitter = function(options) {
		...
		if (o.showHeading) {
			$(this).append('<h2 class="corner-5500">' + o.headingText + '<span class="right"><a href="http://twitter.com/elaniobro" class="twitter-follow-button right" data-link-color="FFFFFF" data-width="140px" data-align="right" data-show-count="false">Follow</a><script src="http://platform.twitter.com/widgets.js" type="text/javascript"></script></span></h2>');
			//$(this).append('<h2 class="corner-5500">'+o.headingText+' <span class="right">@'+o.userName+'</span></h2>');
		}
